...
public class ObservableFlameBuilder {
	...
	/**
	 * Returns Size of the list of transformations ( = the number of
	 * transformations ).
	 * 
	 * @return the size
	 */
	...
	/**
	 * Returns the affine transformation that take place at a certain index in
	 * the table of affineTranformations.
	 * 
	 * @param index
	 ...
	 *            New component for the affine part of the flame transformation
	 * @throws IndexOutOfBoundsException
	 ...
	 * 
	 * @param index
	 *            Index where the variation, we want to change the weight, is
	 * @param variation
	...
	public void setVariationWeight(int index, Variation variation,
		...
		if (newWeight != variationWeight(index, variation)){
